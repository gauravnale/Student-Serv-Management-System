...
class StudentChatList extends Component
{
    ...
    public function chatuserselected(Conversation $conversation, $receiversid)
    {
        ...
        $this->emitTo('chat.student.student-chat-box', 'loadconversation', $this->selectedconversation, $receiverinstance);
    }
    ...
    public function render()
    {
        ...
        return view('livewire.chat.student.student-chat-list', compact('users'));
    }
    public function checkconversation($receiverid)
    {
        ...
        if ($checkconversation->count() == 0) {
            ...
            $newmessage->message = 'Hi, I am ' . auth()->user()->name;
            $newmessage->save();
