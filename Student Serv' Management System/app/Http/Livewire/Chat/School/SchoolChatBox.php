...
class SchoolChatBox extends Component
{
    ...
    public function loadMoreMessages()
    {
        ...
        $this->emitTo('chat.school.school-create-chat', 'loadmessagereceiver', $this->selectedconversation, $this->receiverinstance);
    ...
    {
        return view('livewire.chat.school.school-chat-box');
    }
}
