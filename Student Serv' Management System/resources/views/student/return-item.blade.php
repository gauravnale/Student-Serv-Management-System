        ...
        <div class="card-body invoice-padding pt-0">
            <div class="row invoice-spacing">
                <div class="col-xl-8 p-0">
                    <h6 class="mb-2">Product Seller:</h6>
                    <h6 class="mb-25">{{ ucwords($product->cartseller->name) }}</h6>

                    <p class="card-text mb-25">{{ $product->cartseller->phone_number }} </p>
                    <p class="card-text mb-0">{{ $product->cartseller->email }}</p>
                </div>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td><span class="fw-bold">${{ $product->cartproduct->price }}</span></td>
                            </tr>
                            <tr>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                        ...
                        <tr>
                            <td class="py-1">
                                <p class="card-text fw-bold mb-25">{{ $product->cartproduct->product_name }}</p>
                            ...
                            <td class="py-1">
                                <span class="fw-bold">$ {{ $product->cartproduct->price }}</span>
                            </td>
                            <td class="py-1">
                                <span class="fw-bold">$ {{ $product->cartproduct->price }}</span>
                                <a href="{{ route('student.returneditem', $product->id) }}" class="btn btn-success">Yes Return Product</a>
                            </td>
                        </tr>
